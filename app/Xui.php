...
class Xui{
    ...
    public function login(){
        ...
        CURLOPT_URL => 'https://'.$this->host.':' . $this->port . '/login',
    ...
    public function users(){
        $curl = curl_init();
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://'.$this->host.':' . $this->port . '/xui/inbound/list',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_COOKIEFILE => './.cookie.txt',
    ...
    public function delete($uid){
        $curl = curl_init();
        curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://'.$this->host.':' . $this->port . '/xui/inbound/del/' . $uid,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_COOKIEFILE => './.cookie.txt',
    ...
    public function genVmess($remark = null, $port = null, $traffic = 0){
        ...
        $guidv4 = $this->guidv4();
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://'.$this->host.':' . $this->port . '/xui/inbound/add');
